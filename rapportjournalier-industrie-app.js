(function () {
  ...
  function getReportInputs() {
    return {
      ...
      reportTitle: (document.getElementById("reportTitle").value || "").trim() || "Rapport journalier des visites Industrie",
  ...
  async function chargerRapportJournalier() {
    ...
    try {
      setStatus("Chargement des visites Industrie du jour...");
  ...
  async function exporterPDF() {
    ...
    try {
      ...
      var filename = "rapport_journalier_industrie_" + safeDate + ".pdf";
  ...
  function initPage() {
    ...
    renderInsights(reportStats);
    renderPreview([]);
    setStatus("Pret. Choisis une date puis charge les visites Industrie.");
  }
